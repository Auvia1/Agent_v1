...
# # ==========================================================
# # 🤖 WHATSAPP PROMPT — ORIGINAL FULL VERSION
# # ==========================================================
...
#                         """Check doctor availability by specialty. Map user symptoms to: 'General Physician',
#                         'Dermatologist', 'Cardiologist', 'Pediatrician', 'Orthopedic', or 'Urologist'."""
#                         p = WAParams()
...
#                                 return {
#                                     "status": "success",
#                                     "message": "Say EXACTLY: 'Your appointment has been tentatively booked! Please click the Razorpay link above to confirm your slot. Note: The payment link expires in 15 minutes.'"
#                                 }
#                             else:
#                                 return {
#                                     "status": "success",
#                                     "message": "Say EXACTLY: 'Your free 1-week follow-up has been successfully booked! No payment is required. See you then!'"
#                                 }
#                         return result_data
...
#                             if valid_parts:
#                                 chat_history.append(types.Content(role=msg["role"], parts=valid_parts))
...
# ==========================================================
# 🤖 WHATSAPP PROMPT GENERATOR (DYNAMIC)
# ==========================================================
def generate_whatsapp_prompt(specialties_list: str) -> str:
    ist = pytz.timezone('Asia/Kolkata')
    current_time = datetime.now(ist).strftime('%A, %B %d, %Y at %I:%M %p IST')

    return f"""Role: Mithra Hospital AI Receptionist (WhatsApp).
CURRENT LIVE TIME: {current_time}
...
You MUST internally map the user's symptoms to the most relevant specialty from this list before calling `check_availability_wa`. 
